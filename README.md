...
```javascript
  // umd 格式
  "main": "dist/legao-components.umd.js",
  // es modules 格式
  "module": "dist/legao-components.esm.js",
```
...
```javascript
import Lego from 'legao-components'
// 加载样式
import 'legao-components/dist/legao-components.css'
